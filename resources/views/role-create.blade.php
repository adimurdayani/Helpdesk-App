...
@section('content_header_subtitle', 'Tambah Data Hak Akses')
                    ...
                    <form action="{{ route('role.store') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="name"
                                class="form-control @error('name') is-invalid @enderror" value="{{ old('guard_name') }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="guard_name" id="guard_name"
                                class="form-control @error('guard_name') is-invalid @enderror" value="{{ old('guard_name') }}"
