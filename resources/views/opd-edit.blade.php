                ...
                <div class="card-body">
                    <form action="{{ route('opd.update', $instansi->id) }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="kode_opd" id="kode_opd" value="{{ $instansi->kode_opd }}"
                        ...
                        <div class="form-group">
                            ...
                            <select name="is_active" id="is_active"
                                ...
                                <option value="1" {{ $instansi->is_active == '1' ? 'selected' : '' }}>Aktif</option>
                                <option value="0" {{ $instansi->is_active == '0' ? 'selected' : '' }}>Tidak Aktif
                                </option>
                            </select>
                            @error('is_active')
                                <div class="invalid-feedback">{{ $message }}</div>
